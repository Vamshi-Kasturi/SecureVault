...
echo.
echo Make sure MongoDB is running on localhost (mongodb://127.0.0.1:27017/securefiles)
echo If your credentials or port differ, please update DATABASE_URL in backend_node/.env
echo.
